...
def initDb(app):
    with app.app_context():
        db = getDb()
        db.execute("""CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT UNIQUE NOT NULL, password TEXT NOT NULL, avatar TEXT NOT NULL, display TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP)""")
